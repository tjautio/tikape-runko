...
public class AihealueDao implements Dao<Aihealue, Integer> {
    ...
    public Aihealue findOne(Integer key) throws SQLException {
        ...
        PreparedStatement stmt = connection.prepareStatement("SELECT * FROM Aihealueet WHERE id = ?");
        ...
        int aihealueId = rs.getInt("aihealue_id");
        String nimi = rs.getString("nimi");
  

        Aihealue a = new Aihealue(aihealueId, nimi);
    ...
    public List<Aihealue> findAll() throws SQLException {
        ...
        while (rs.next()) {
            int alueId = rs.getInt("aihealue_id");
            String nimi = rs.getString("nimi");
            

            alueet.add(new Aihealue(alueId, nimi));
        }
